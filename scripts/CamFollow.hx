// Script original de DR, yo modifiqué algunas pelotudeces, nada más.
...
function onSongStart() {
    Paths.clearUnusedMemory(); // Integro esta mierda dentro de este script, paso de tener otro archivo para esto xd
}
